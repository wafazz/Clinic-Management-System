<x-app-layout>
    <x-slot name="header"><h4 class="font-weight-bold mb-0">Edit User: {{ $user->name }}</h4></x-slot>
            ...
            <form method="POST" action="{{ route('users.update', $user) }}">
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $user->is_active) ? 'checked' : '' }} class="form-check-input" />
